...
CRYPTREST_LETSENCRYPT_BRANCH="${CRYPTREST_LETSENCRYPT_BRANCH:=master}"
CRYPTREST_LETSENCRYPT_DIR="$CRYPTREST_ENV_DIR/letsencrypt"
CRYPTREST_LETSENCRYPT_PATH="$CRYPTREST_SRC_DIR/letsencrypt"
CRYPTREST_LETSENCRYPT_ETC_DIR="$CRYPTREST_ETC_DIR/letsencrypt"
CRYPTREST_LETSENCRYPT_CERTBOT_DIR="$CRYPTREST_LETSENCRYPT_DIR/certbot-$CRYPTREST_LETSENCRYPT_BRANCH"
CRYPTREST_LETSENCRYPT_GIT_URL="https://github.com/letsencrypt/letsencrypt/archive/$CRYPTREST_LETSENCRYPT_BRANCH.tar.gz"
...
letsencrypt_define()
{
    ...
    ln -s "$CRYPTREST_LETSENCRYPT_DIR/renew.sh" "$CRYPTREST_BIN_DIR/letsencrypt-renew" && \
