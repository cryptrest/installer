...
/home/$UPSTREAM/letsencrypt/certbot/certbot-auto certonly --standalone --email $DOMAIN@gmail.com --renew-by-default --rsa-key-size 2048 -d $DOMAIN -d www.$DOMAIN --pre-hook "service nginx stop" --post-hook "service nginx start"
