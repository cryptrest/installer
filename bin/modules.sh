...
CRYPTREST_MUDULES_BIN_DIR="$CRYPTREST_LIB_DIR/installer-$CRYPTREST_GIT_BRANCH/bin"
CRYPTREST_MUDULES_BIN_FILE="$CRYPTREST_MUDULES_LIB_DIR/modules.sh"
