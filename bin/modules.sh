...
CRYPTREST_INSTALLER_GIT_URL="https://github.com/$CRYPTREST_NAME/i/archive/$CRYPTREST_INSTALLER_GIT_BRANCH.tar.gz"
CRYPTREST_USER="$USER"
...
CRYPTREST_MUDULES_LIB_BIN_DIR="$CRYPTREST_LIB_DIR/i-$CRYPTREST_INSTALLER_GIT_BRANCH/bin"
