...
CRYPTREST_SSL_ECDH_CURVE="${CRYPTREST_SSL_ECDH_CURVE:=secp384r1}"
...
cryptrest_init()
{
    ...
    echo "CRYPTREST_SSL_ECDH_CURVE=\"$CRYPTREST_SSL_ECDH_CURVE\"" >> "$CRYPTREST_ENV_FILE"
...
cryptrest_define()
{
    ...
    ln -s "$CRYPTREST__COMMON_WWW_ASSETS_DIR/favicon.ico" "$CRYPTREST_INSTALLER_WWW_DIR/" && \
