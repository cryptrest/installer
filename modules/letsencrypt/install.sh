...
CRYPTREST_LETSENCRYPT_LOG_DIR="$CRYPTREST_LOG_DIR/$CRYPTREST_LETSENCRYPT_NAME"
...
letsencrypt_install()
{
    ...
    mkdir -p "$CRYPTREST_LETSENCRYPT_LOG_DIR" && \
    chmod 700 "$CRYPTREST_LETSENCRYPT_LOG_DIR" && \
