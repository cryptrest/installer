...
letsencrypt_define()
{
    ...
    echo "CRYPTREST_LETSENCRYPT_ETC_SYS_DIR=\"$CRYPTREST_LETSENCRYPT_ETC_SYS_DIR\"" >> "$CRYPTREST_LETSENCRYPT_ETC_ENV_FILE"
    ...
    echo "CRYPTREST_LETSENCRYPT_ARCH=\"$CRYPTREST_LETSENCRYPT_ARCH\"" >> "$CRYPTREST_LETSENCRYPT_ETC_ENV_FILE"
    echo "CRYPTREST_LETSENCRYPT_OS=\"$CRYPTREST_LETSENCRYPT_OS\"" >> "$CRYPTREST_LETSENCRYPT_ETC_ENV_FILE"
