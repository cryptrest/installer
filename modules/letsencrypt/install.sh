...
CRYPTREST_LETSENCRYPT_VAR_LOG_DIR="$CRYPTREST_DIR/var/log/$CRYPTREST_LETSENCRYPT_NAME"
...
letsencrypt_install()
{
    ...
    mkdir -p "$CRYPTREST_LETSENCRYPT_VAR_LOG_DIR" && \
    chmod 700 "$CRYPTREST_LETSENCRYPT_VAR_LOG_DIR" && \
